...
if __name__ == "__main__":
    ...
    txt = '''
        ...
        WELCOME TO KRONFROST LABRATORY AT UCHIAGO -- SCALE PROJECT DB PROJECT 

        ALPHA PROGRAM - (11/08/2020) - Dev - Lukas Elsrode 
    ...
    # info, data 
    info, data = gen_rgb_data()

    print('Initilizing DataStructure')
    print('\n')
    ...
    for f_viz in vizulizations:
        ...
        viz_data.run_viz_by_field(data, f_viz, color_map, 'scale_color')
